  ...
  return (
    <div className="app">
      ...
      <main className="main">
        ...
        {tab === "groups"   && <Groups groups={groups} fixtures={fixtures} entries={entries} />}
        {tab === "fixtures" && <Fixtures fixtures={fixtures} groups={groups} entries={entries} />}
        {tab === "bracket"  && <Bracket knockout={knockout} groups={groups} entries={entries} entryFee={ENTRY_FEE} prizes={PRIZES} />}
